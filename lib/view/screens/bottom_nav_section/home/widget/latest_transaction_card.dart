                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: Dimensions.space10),
                        Text("${Converter.formatNumber(/*controller.trxList[index].amount ?? */ "")} ${/*controller.trxList[index].currency?.currencyCode ??*/ ""}", style: regularDefault.copyWith(color: MyColor.getTextColor(), fontWeight: FontWeight.w600))
                      ],
                    )
                  ],
                ),
