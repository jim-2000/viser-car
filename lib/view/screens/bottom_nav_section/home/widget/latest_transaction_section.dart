...
import 'package:customer/view/screens/bottom_nav_section/home/widget/latest_transaction__bottom_sheet.dart';
import 'package:customer/view/screens/bottom_nav_section/home/widget/latest_transaction_card.dart';
          ...
          children: [
            ...
            ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return LatestTransactionCard(index: index, isShowDivider: /*controller.trxList.length-1!=index*/ true, press: () => CustomBottomSheet(child: LatestTransactionBottomSheet(index: index)).customBottomSheet(context));
                }),
          ],
        ),
      ),
