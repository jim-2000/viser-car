...
import 'package:customer/view/components/card/bottom_sheet_card.dart';
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                ...
                child: BottomSheetCard(
                  child: Text('+${controller.countryList[index].dialCode}  ${controller.countryList[index].country?.tr ?? ''}', style: regularDefault.copyWith(color: MyColor.getTextColor())),
                ),
              );
            })
      ],
