...
import 'package:customer/data/controller/auth/two_factor_controller.dart';
...
class TwoFactorVerificationScreen extends StatefulWidget {
  ...
  const TwoFactorVerificationScreen({Key? key, required this.isProfileCompleteEnable}) : super(key: key);
