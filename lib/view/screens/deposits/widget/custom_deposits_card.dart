...
class CustomDepositsCard extends StatelessWidget {
  ...
  const CustomDepositsCard({Key? key, required this.trxValue, required this.date, required this.status, required this.statusBgColor, required this.amount, required this.onPressed}) : super(key: key);
