...
class BottomSheetRow extends StatelessWidget {
  ...
  const BottomSheetRow({Key? key, required this.header, required this.body, this.showSymbol = false, this.curBgColor = MyColor.primaryColor, this.currencySymbol}) : super(key: key);
