...
class CircleButtonWithIcon extends StatelessWidget {
  ...
  const CircleButtonWithIcon(
      {Key? key, this.imagePath = '', this.isAsset = false, this.circleSize = 30, this.imageSize = 20, this.isSvg = false, this.isShowBorder = false, this.isIcon = true, this.bg = Colors.transparent, this.padding = 5, required this.press, this.iconColor = MyColor.colorWhite, this.iconSize = 20, this.isProfile = false, this.borderColor = MyColor.borderColor, this.icon = Icons.clear})
      : super(key: key);
