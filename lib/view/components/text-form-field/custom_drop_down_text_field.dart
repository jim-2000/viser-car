...
import 'package:customer/view/components/text/label_text.dart';
...
class CustomDropDownTextField extends StatefulWidget {
  ...
  const CustomDropDownTextField({Key? key, this.labelText, this.hintText, required this.selectedValue, required this.onChanged, required this.items, this.fillColor = MyColor.transparentColor, this.focusColor = MyColor.colorWhite, this.dropDownColor = MyColor.colorWhite, this.iconColor = MyColor.colorGrey, this.radius = 3, this.needLabel = true}) : super(key: key);
