...
class CustomDropDownWithTextField extends StatefulWidget {
  ...
  const CustomDropDownWithTextField({Key? key, this.title, this.selectedValue, this.list, this.onChanged}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Container(
          height: 45,
          decoration: BoxDecoration(color: MyColor.transparentColor, borderRadius: const BorderRadius.all(Radius.circular(5)), border: Border.all(color: MyColor.textFieldDisableBorderColor)),
          child: Padding(
