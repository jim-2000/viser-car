...
class CircleShapeImage extends StatefulWidget {
  ...
  const CircleShapeImage({Key? key, this.backgroundColor = MyColor.screenBgColor, this.imageColor, this.size = 35, required this.image, this.isSvgImage = false}) : super(key: key);
