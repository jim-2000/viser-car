...
class CardButton extends StatelessWidget {
  ...
  const CardButton({Key? key, this.text, required this.icon, this.isText = true, this.bgColor = MyColor.primaryColor, this.contentColor = MyColor.colorWhite, required this.press}) : super(key: key);
