      ...
      child: GestureDetector(
        ...
        child: Transform.scale(
          ...
          child: Column(
            ...
            children: [Container(height: widget.height, width: widget.width, alignment: Alignment.center, decoration: BoxDecoration(color: widget.backgroundColor, shape: BoxShape.circle), child: widget.child), const SizedBox(height: 10), Text(widget.buttonName.tr, textAlign: TextAlign.center, style: regularExtraSmall.copyWith(color: MyColor.primaryTextColor, fontWeight: FontWeight.w500))],
          ),
        ),
      ),
    );
