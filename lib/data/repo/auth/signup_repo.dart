...
import 'package:customer/data/model/auth/sign_up_model/registration_response_model.dart';
import 'package:customer/data/model/auth/sign_up_model/sign_up_model.dart';
...
class RegistrationRepo {
  ...
  Map<String, dynamic> modelToMap(SignUpModel model) {
    Map<String, dynamic> bodyFields = {'mobile': model.mobile, 'email': model.email, 'agree': model.agree.toString() == 'true' ? 'true' : '', 'username': model.username, 'password': model.password, 'password_confirmation': model.password, 'country_code': model.countryCode, 'country': model.country, "mobile_code": model.mobileCode};
